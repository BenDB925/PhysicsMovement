...
- 2026-03-22 Slice 4: The remaining red was still a 45.9° landing-tilt overrun in `SprintJump_TwoConsecutiveJumps_DoesNotFaceplant`, so I took the smallest same-slice landing retune: clamp BalanceController’s prefab-backed landing absorb lean to 1.4° instead of 1.5°. That keeps the Slice 3 touchdown recovery shape but trims the extra forward pitch impulse the new air-control path exposed.
