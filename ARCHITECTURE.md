...
| **Public Surface** | `HasCommandFrame: bool`, `IsPassThroughMode: bool`, `IsRecoveryActive: bool`, `LastRecoveryDuration: float`, `LastRecoveryEndedInSurrender: bool`; internal snapshots for current desired input, shared sensor data, filtered observation, support command, left/right leg commands, and recovery telemetry log. |
