...
|---|---|---|---|
| Issue-driven workflow setup, PRD or slice writing, bug escalations, launch-label setup, or documentation-slimming pilot prep | `.github/instructions/issue-driven-agent-workflow.instructions.md` | `Plans/issue-driven-agent-workflow.plan.md`, `Plans/issue-driven-agent-workflow/04-issue-model-and-pilot-decisions.md`, `.github/ISSUE_TEMPLATE/*.yml`, `Plans/README.md`, `Tools/Sync-IssueWorkflowLabels.ps1` | Confirm the linked plan doc exists, the issue body stays thin, the required labels are present, and the parent plan reflects the latest next step |
...
| Knockdown, surrender, external impacts, floor dwell, or stand-up sequencing | `Assets/Scripts/Character/BalanceController.cs`, `Assets/Scripts/Character/CollisionImpactReceiver.cs`, `Assets/Scripts/Character/CharacterState.cs`, `Assets/Scripts/Character/ImpactKnockdownDetector.cs`, `Assets/Scripts/Character/KnockdownSeverity.cs`, `Assets/Scripts/Character/ProceduralStandUp.cs`, `Assets/Scripts/Character/KnockdownEvent.cs`, `Assets/Scripts/Character/RagdollSetup.cs` | `Plans/comedic-knockdown-overhaul.plan.md`, the matching chapter doc under `Plans/comedic-knockdown-overhaul/`, plus `ARCHITECTURE.md` and `.copilot-instructions.md` | `Assets/Tests/PlayMode/Character/SurrenderTests.cs`, `Assets/Tests/PlayMode/Character/ImpactKnockdownTests.cs`, `Assets/Tests/PlayMode/Character/FloorDwellTests.cs`, `Assets/Tests/PlayMode/Character/ProceduralStandUpTests.cs`, plus `Assets/Tests/PlayMode/Character/BalanceControllerTests.cs`, `Assets/Tests/PlayMode/Character/HardSnapRecoveryTests.cs`, `Assets/Tests/PlayMode/Character/GetUpReliabilityTests.cs`, and `Assets/Tests/PlayMode/Character/RagdollSetupTests.cs` |
