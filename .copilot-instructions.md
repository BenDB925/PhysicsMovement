...
| 2 — Balance Controller | **Scripts written (2A+2B+2C done)** | Joint drives added in 2A. `GroundSensor.cs` done in 2B. `BalanceController.cs` done in 2C — PD torque, IsFallen, SetFacingDirection. Tests 12/12 passing. |
